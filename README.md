...
* q [строка, обязателен] - идентификатор организации: ОКПО, ИНН или ОГРН.
* qi [строка, обязателен] - идентификатор физического лица - Фамилия имя и отчество полностью (ФИО),
...
`?q=60510227&q=1117746960704&q=7703561549&qi=Костюк+Андрей+Григорьевич&qi=Малеев+Владимир+Иванович`

Несколько идентификаторов организаций можно передать в одном параметре `q`, а
несколько ФИО - в одном параметре `qi`. Для этого необходимо разделить их символом
перевода строки (ASCII код `0x0A`):

Пример:

`?q=60510227%0A1117746960704%0A7703561549&qi=Костюк+Андрей+Григорьевич%0AМалеев+Владимир+Иванович`
...
`GET https://www.creditnet.ru/nkbrelation/api/connections?qi=Костюк+Андрей+Григорьевич&qi=Малеев+Владимир+Иванович`
